...
LOCK TABLES `flattype` WRITE;
/*!40000 ALTER TABLE `flattype` DISABLE KEYS */;
INSERT INTO `flattype` VALUES (1,'1BHK'),(2,'2BHK'),(3,'3BHK'),(4,'Duplex');
/*!40000 ALTER TABLE `flattype` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-03-14 11:25:53
